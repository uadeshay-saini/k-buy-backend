...
const ordersDeliveredArray = new Schema({
...
const ordersDeliveredSchema = new Schema(
    {
        userId: {
            type: Schema.Types.ObjectId,
            ref: "User"
        ...
        ordersDeliveredArray: [ordersDeliveredArray],
...
export const OrdersDelivered = mongoose.model("OrdersDelivered", ordersDeliveredSchema)